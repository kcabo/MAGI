...
# initialize_stats_table()
    ...
    if len(args) == 1:
        ...
        target_meets_ids = [518703,3018304,1718301,3818664,518718,1618754,
        2418602,2318752,2118622,3818602,2218726,1818662,618341,2218625,
        2818614,4818404,2118621,618351,4118705,1718351,3218717,418601,2818704,4818403,1118603,418301,1518211,4218702,7018702]
