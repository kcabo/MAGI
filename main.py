...
# initialize_stats_table()
    ...
    if len(args) == 1:
        ...
        target_meets_ids = [1917662,1117604,2817619,3017608,2317752,2817615,1317501,5317405,
        2517704,2217727,3217721,2717635,117731,2417604,517616,4317741,5017409,4717715,1517726,
        1117630,2117694,5117401,2017651,117722,1417701,2917703,1017601,1617771,2817501,417201]

        target_meets_ids = [4218702, 7018702]
